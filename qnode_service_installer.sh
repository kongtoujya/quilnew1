...
if [ -d "ceremonyclient" ]; then
  ...
  until git clone https://gh.xmly.dev/https://github.com/QuilibriumNetwork/ceremonyclient.git || git clone  git clone https://git.quilibrium-mirror.ch/agostbiro/ceremonyclient.git; do
